  ...
  return (
    ...
    >
      <div className='h-full w-full flex flex-col gap-5 m-auto justify-center text-center lg:text-start'>
        ...
        >
          I&apos;m <span className='text-transparent font-bold bg-clip-text bg-gradient-to-r from-white to-cyan-500'>Vishal Pundhir</span>, a full stack developer with 2+ years of experience and a passion for creating beautiful and functional
